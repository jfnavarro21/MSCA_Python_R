...
par(mfcol=c(2,1))
plot(d2, xlab="year", ylab="returns",type="l")
...
# Plot the time series and its ACF for simple returns
par(mfcol=c(2,1))
plot(d10, xlab="year", ylab="returns",type="l")
...
Model checking using Ljung-Box
```{r}
